...
const AccountList = () => {
  ...
  return (
    <table className="bg-gray-100 w-full overflow-auto">
      ...
      {accounts.map(account => (
        <tbody className="flex justify-between w-full bg-slate-200" key={account.uuid}>
          <tr className="justify-center flex flex-1 w-max">
