      ...
      <thead className="flex w-full px-2 py-4">
        ...
        {accounts.map(account => (
            <tbody className='flex justify-between'>
              <tr className="justify-self-center"><td>증권사</td></tr>
              <tr className="justify-self-center"><td>계좌번호</td></tr>
              <tr className="justify-self-center"><td>고객명</td></tr>
              <tr className="justify-self-center"><td>운용상태</td></tr>
              <tr className="justify-self-center"><td>{account.name}</td></tr>
              <tr className="justify-self-center"><td>평가금액</td></tr>
              <tr className="justify-self-center"><td>입금금액</td></tr>
              <tr className="justify-self-center"><td>수익률</td></tr>
              <tr className="justify-self-center"><td>계좌활성화</td></tr>
              <tr className="justify-self-center"><td>{account.created_at}</td></tr>
            </tbody>
          ))}
      </thead>
    </table>
