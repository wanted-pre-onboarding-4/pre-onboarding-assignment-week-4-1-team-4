...
const AccountList = () => {
  ...
  return (
    <div className='px-4 py-8 w-full bg-gray-100'>
    <table className="bg-gray-200 w-full border-solid border-[1px] rounded-xl">
      <thead className="flex w-full px-2 py-4 rounded-tl-xl">
