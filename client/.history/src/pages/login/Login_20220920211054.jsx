  ...
  return (
    <div>
      ...
      <form>
        ...
        <button className='flex items-center space-x-2 border-solid border-[1px] p-2 disabled:text-gray-100 disabled:bg-gray-300' disabled={true}><BiLogIn/><span>로그인</span></button>
      </form>
    </div>
  );
};
