    ...
    <div className="flex flex-col justify-center items-center w-full gap-y-6">
      ...
      <div className="border-solid border-[1px] rounded-md shadow-md shadow-gray-300 w-1/2">
        ...
        <form className="flex flex-col gap-y-8 p-4">
          ...
          <button
            className="flex items-center justify-center space-x-2 w-full text-lg border-solid border-[1px] p-2 rounded text-white bg-blue-900 duration-150 ease-linear disabled:text-gray-400 disabled:bg-gray-100"
            disabled={!formValid}
          >
            <BiLogIn />
            <span>로그인</span>
