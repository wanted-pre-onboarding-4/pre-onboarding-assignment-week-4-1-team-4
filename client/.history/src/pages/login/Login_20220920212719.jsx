      ...
      <div className='border-solid border-[1px] rounded-md shadow-md shadow-gray-300 w-1/2'>
        ...
        <form className='flex flex-col gap-y-8 p-4'>
          <label className="flex items-center space-x-2 border-solid border-[1px] p-2">
            <BsPerson />
            <input type="email" placeholder="이메일을 입력하세요" className='outline-none p-1 rounded-sm' />
          </label>
          <label className="flex items-center space-x-2 border-solid border-[1px] p-2">
            <AiOutlineLock />
            <input type="password" placeholder="비밀번호를 입력하세요" className='outline-none p-1 rounded-sm' />
          </label>
          <button
