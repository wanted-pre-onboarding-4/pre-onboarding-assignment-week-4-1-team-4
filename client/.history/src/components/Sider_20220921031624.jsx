      ...
      <ul>
        ...
        >
          <NavLink
            ...
            className="flex items-center px-6 space-x-2 py-4 text-red-300 justify-between cursor-pointer"
          >
          ...
          {openSubCategory && (
            <NavLink
              to="/accounts/:id"
              className="flex items-center px-6 space-x-2 py-4 text-red-300"
        ...
        <li>
          <NavLink to="/users" className="flex items-center px-6 space-x-2 py-4 text-red-300">
            <BsPerson />
            <span>사용자</span>
          </NavLink>
        </li>
