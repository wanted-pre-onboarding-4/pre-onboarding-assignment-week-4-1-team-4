      ...
      <ul>
        ...
        <li onClick={()=>setOpenSubCategory(pre=>!pre)}>
          ...
          >
            ...
            <div>
              {openSubCategory ? <MdKeyboardArrowUp className='fill-gray-300'/> :<MdKeyboardArrowDown className='fill-gray-300'/>}
            </div>
          </NavLink>
          {openSubCategory && (
            <NavLink className='flex justify-center items-center py-6 space-x-2 text-gray-300'>
              <IoMdAnalytics />
              <span>투자 계좌</span>
            </NavLink>
          )}
