...
const Sider = () => {
  return (
    <div className="w-52 bg-blue-900">
      ...
      <ul>
        <li className="flex items-center px-6 space-x-2 text-white">
          <AiOutlineDashboard />
          <span>대시보드</span>
        </li>
        <li>
          <NavLink
            to="/accounts"
            className="flex items-center justify-between space-x-2 py-4 text-white px-6"
          >
      ...
      <button className="flex items-center px-6 space-x-2 text-white">
