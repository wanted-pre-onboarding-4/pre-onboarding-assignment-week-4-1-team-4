  ...
  return (
    <div className="w-52 bg-blue-900">
      ...
      <ul>
        ...
        <li onMouseOver={() => setOpenSubCategory(pre => !pre)} onMouseLeave={()=>setOpenSubCategory(pre=>!pre)}>
          <NavLink
            to="/accounts"
            className={({ isActive }) =>
              isActive ? activeLink  + ' justify-between cursor-pointer' : normalLink + ' justify-between cursor-pointer'
            }
          >
