...
const Sider = () => {
  return (
    <div className="w-max bg-blue-900">
      ...
      <ul>
        <li>
          <NavLink to="/" className="flex items-center space-x-2 text-white px-6" activeClassName="text-red-100 hover:text-red-100 bg-red-700">
            <AiOutlineDashboard />
            <span>대시보드</span>
          </NavLink>
        </li>
        <li>
          <NavLink to="/" className="flex items-center justify-between space-x-2 text-white px-6">
